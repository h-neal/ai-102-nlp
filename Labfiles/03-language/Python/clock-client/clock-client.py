    ...
    try:
        ...
        while userText.lower() != 'quit':
            ...
            if userText.lower() != 'quit':
                ...
                print("\tcategory: {}".format(result["result"]["prediction"]["intents"][0]["confidenceScore"]))
                ...
                for entity in entities:
                    ...
                    print("\tconfidence score".format(entity["confidence score"]))
                ...
                if top_intent == 'GetTime':
                    ...
                    # Get the time for the specifiied location
